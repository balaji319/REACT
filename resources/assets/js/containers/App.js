...
class App extends Component {
    ...
    componentWillMount() {
     ...
     handlebgimg1 = () => {
            ...
            length > 0  ? el.className += "Ycc-login-bg" :el.classList.remove("Ycc-login-bg");
        }
    ...
    render() {
        const {match, location, themeColor, isDarkTheme, locale, authUser, initURL, isDirectionRTL,status_error} = this.props;
                    ...
                    <IntlProvider
                        ...
                        <RTL>
                            <div className="app-main">
                                ...
                                { status_error && NotificationManager.error("Somthing went wrong !!!!!")}
...
const mapStateToProps = ({settings, auth,globel}) => {
    const {themeColor, sideNavColor, darkTheme, locale, isDirectionRTL} = settings;
    const {authUser, initURL} = auth;
    const {status_error} = globel;
    return {themeColor, sideNavColor, isDarkTheme: darkTheme, locale, isDirectionRTL, authUser, initURL,status_error}
};
