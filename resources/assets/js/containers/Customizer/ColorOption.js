...
import {changeDirection, setDarkTheme, setThemeColor,hideNav} from '../../actions/index';
...
class ColorOption extends React.Component {
    ...
    render() {
        const {themeColor, darkTheme, isDirectionRTL,navopen} = this.props;
     
          this.state = {drawerStatus: navopen}
                ...
                <Drawer className="app-sidebar-content right-sidebar"
                    ...
                    <div className="color-theme">
                        <div className="color-theme-header">
                            <h3 className="color-theme-title">Ytel Service Panel </h3>
...
const mapStateToProps = ({settings}) => {
    const {themeColor, darkTheme, isDirectionRTL,navopen} = settings;
    return {themeColor, darkTheme, isDirectionRTL,navopen}
};

export default withRouter(connect(mapStateToProps, {setThemeColor,hideNav, setDarkTheme, changeDirection})(ColorOption));
