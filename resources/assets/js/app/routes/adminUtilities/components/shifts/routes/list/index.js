...
class List extends React.Component {
  ...
  render() {
    ...
    return (
      <div>
        <ContainerHeader match={this.props.match} title="Shifts Listing " />
            ...
            <div className="table-responsive-material">
              <Table className="">
                      ...
                      .map(n => {
                        return (
                          <TableRow key={n.shift_id}>
                            <TableCell style={divStyle}>{n.shift_id}</TableCell>
                            ...
                            >
                              <Tooltip title="Modify Script">
                                <IconButton
                                  onClick={() =>
                                    this.handleEditEventHandler(n.shift_id)
                                  }
                                >
                              ...
                              <Tooltip title="Delete Script">
                                <IconButton
                                  onClick={() =>
                                    this.DeleteInboundHandler(n.shift_id)
                                  }
                                >
                ...
                <TableFooter>
                  <TableRow>
                    <TablePagination
                      count={Agent.data ? Agent.data.length : 1}
