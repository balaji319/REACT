...
class Clone extends React.Component {
  ...
  handleNext = () => {
    ...
    if (this.state.selected_list_id == "") {
      this.setState({ selectListError: true });
      isError = true;
    } else {
                    ...
                    <div className="col-lg-12 col-sm-12 col-12">
                      <FormControl className="w-100 mb-2">
                        ...
                        <Select
                          ...
                          onChange={this.handleTextChange("selected_list_id")}
