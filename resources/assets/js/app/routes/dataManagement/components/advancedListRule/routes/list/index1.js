...
class AgentStatusDetail extends React.Component {
            ...
            handleRequestSort = (event, property) => {
                ...
                const data =
                    order === 'desc' ? this.state.data.sort((a, b) => (b[orderBy] < a[orderBy] ? -1 : 1)) : this.state.data.sort((a, b) => (a[orderBy] < b[orderBy] ? -1 : 1));
            ...
            handleStartCloning = () => {
                ...
                if(!isError)
                this.setState({showCloneConfirm:true});
            }
       ...
       handleCloneConfirm = () =>{   
             this.setState({showCloneConfirm:false});  
                let _this = this;
                axios.post('/api/admin-utilities/clone-script',{new_script_id:this.state.newScriptId, from_script_id:this.state.fromScriptId})
                    .then(response => {
                       _this.setState({
            ...
            componentWillReceiveProps(nextPropsFromRedux) {
              ...
              this.setState({  
                ...
                alertContent: nextPropsFromRedux.admin_utilites.showMessage,
              });
            ...
            render() {
                const {data, order, orderBy, selected, rowsPerPage, page, showAlert,alertContent,alertTitle,showConfirm,showClonePopup,showCloneConfirm,fromScriptId,newScriptId,fromScriptIdError,newScriptIdError} = this.state;
                            ...
                            <Paper>
                              ...
                              <SweetAlert   show={showAlert} 
                                ...
                                <SweetAlert show={showConfirm}
                                 ...
                                 <SweetAlert show={showCloneConfirm}
                                            warning
                                            showCancel
                                            ...
                                            Are you sure that you want to clone script from <strong>{this.state.fromScriptId} </strong> to  <strong>{this.state.newScriptId} </strong>?
                                </SweetAlert>
                                
                                <Dialog maxWidth="md"  fullWidth={true} open={showClonePopup} onClose={this.handleCloneClose}>
                                ...
                                <Toolbar
                                    ...
                                    <div className="title">
                                            <h3><i className="zmdi zmdi-view-web mr-2"/>Script Listing</h3>
                                    </div>
                                    <div className="spacer"/>
                                    <div className="actions">

                                            <Tooltip title="Clone for Script">
                                                <IconButton className='btn-sm' aria-label="Delete" onClick={this.handleShowClonePopup} >
                                                    ...
                                                    {data.slice(page * rowsPerPage, page * rowsPerPage + rowsPerPage).map(n => {
                                                        ...
                                                        return (
                                                                ...
                                                                <Switch 
                                                                        ...
                                                                        defaultChecked={n.active == 'Y'} ref={n.script_id}
                                                                        color="primary"
                                                                        /></TableCell>
                                                                <TableCell className='text-center'> 
                                                                    
                                                                    <Tooltip title="Modify Script">
                                                                        <IconButton onClick={()=>this.handleEditScript(n.script_id)}>
                                                                            <i className="zmdi zmdi-edit font-20" />
                                                                        </IconButton>     
                                                                    </Tooltip>
                                                                         
                                                                    <Tooltip title="Delete Script">
                                                                        <IconButton onClick={()=>this.handleDeleteScript(n.script_id)}>
...
export default connect(mapStateToProps, mapDispatchToProps)(AgentStatusDetail);
