...
class List extends React.Component {
    ...
    DeleteInboundHandler = (id) => { this.setState({ showConfirm: true}); };
    ...
    handleResetListEventHandler= (id) => { 
        this.setState({
            reset_list_status: true,
        });
    }; 


    inboundgroupsHandler = (id) => { this.props.history.push('inboundgroup/' + id) };

    campaignrankHandler = (id) => { this.props.history.push('campaignrank/' + id) };

    sercallbacHandler = (id) => { this.props.history.push('usercallback/' + id) };
    ...
    componentDidMount() {
        //console.log("Data Managememnt" + this.state.data);
                                            ...
                                            <TableRow key={n.list_id} >
                                                ...
                                                <TableCell style={divStyle} className='text-center' style={{ whiteSpace: 'nowrap' }}>
                                                    ...
                                                    <Tooltip title="Delete Script">
                                                        <IconButton onClick={() => this.DeleteInboundHandler(n.list_id)}>
