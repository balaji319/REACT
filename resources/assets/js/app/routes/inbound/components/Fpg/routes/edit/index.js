...
class EditScript extends React.Component {
    ...
    constructor(props) {
        ...
        this.state = {
            ...
            scriptId: this.props.location.pathname.split('/')[4]=='add'?'': this.props.location.pathname.split('/').pop(),
            pageError: false,
            scriptField:'',
            scriptName:'',
            scriptComment:'',
    ...
    componentDidMount() {
        ...
        axios.get('/api/admin-utilities/get-script/' + this.state.scriptId)
                .then(response => {
    ...
    render() {
        ...
        const {pageTitle, pageError, showAlert,alertContent,alertTitle,scriptId,scriptName,scriptComment,scriptActive,scriptActiveValue,scriptText,scriptField,scriptIdError,scriptNameError,scriptCommentError,scriptTextError} = this.state;
