...
const columnData = [
    {id: 'Number', numeric: false,disablePadding: false, textAlign:'left', label: 'Inbound Queues'},
    {id: 'Number Description ', numeric: true, disablePadding: false,   label: 'Name'},
    ...
    {id: 'Number1', numeric: true, disablePadding: false, label: 'Number'},
    {id: 'Call Menu', numeric: true, disablePadding: false, label: 'Call Menu'},
                        ...
                        {columnData.map(column => {
                                return (
                                                        <TableCell className={column.textAlign}
                                                                   ...
                                                                   padding={column.disablePadding ? 'none' : 'default'}
                                                                   style={{textAlign:'left',color:'#040404',fontSize:'15px'}}>
