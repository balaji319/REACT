...
import Dropdown from '../../../../../comman/Elements/Dropdown';
import TextFields from '../../../../../comman/Elements/TextFields';
...
class Clone extends React.Component {
    ...
    cloneAgent = () =>{
        ...
        let $this = this;
        $this.setState({error_msg:false,error_msg_pass:"",sucsess_msg:""})
        ...
        axios.post('/api/clone-agent',data).then(response=>{
           ...
           $this.setState({sucsess_msg:response.data.message})
            ...
            //let flag = 0;
            $this.setState({error_msg:true,error_msg_pass:error.response.data.msg})
