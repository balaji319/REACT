...
const columnData = [
    {id: 'Agent ID ', numeric: false,disablePadding: false, textAlign:'center' ,label: 'Agent ID'},
    {id: 'Name   ', numeric: true, disablePadding: false,textAlign:'center',   label: 'Name'},
    {id: 'Group ', numeric: true, disablePadding: false,textAlign:'center', label: 'Group'},
    {id: 'Active', numeric: true, disablePadding: false,  label: 'Active'},
    {id: 'Agent Stats', numeric: true, disablePadding: false, textAlign:'center',  label: 'Agent Stats'},
    ...
    {id: 'Modify', numeric: true,textAlign:'center', disablePadding: false, label: 'Modify'},
];
