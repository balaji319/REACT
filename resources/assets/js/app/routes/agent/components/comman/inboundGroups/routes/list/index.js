...
class List extends React.Component {
  ...
  componentDidMount() {
    ...
    axios
      .post("/api/inbound-group", formData)
      .then(response => {
              ...
              <Table className="">
                ...
                <TableBody>
                  {this.state.records.map((row, index) => {
                    return (
                      <TableRow
                        key={this.state.records[index].group_name_values}
                      >
                        <TableCell style={divStyle}>
                          <Checkbox
                            ...
                            value={this.state.records[index].day}
                            defaultChecked={this.state.records[index].status}
                          />{" "}
                        ...
                        <TableCell style={divStyle}>
                          ...
                          >
                            {" "}
                            {rank_Count.map(option => (
                              <option
                                key={option}
                                selected={
                                  this.state.records[index].group_rank == option
                                    ? true
                                    : false
                                }
                                value={option}
                        ...
                        <TableCell style={divStyle}>
                          ...
                          >
                            {" "}
                            {grad_Count.map(option => (
                              <option
                                key={option}
                                selected={
                                  this.state.records[index].group_grade ==
                                  option
                                    ? true
                                    : false
                                }
                        ...
                        <TableCell style={divStyle}>
                          <input
                            ...
                            value={this.state.records[index].group_web_vars}
                          />{" "}
                        </TableCell>
                      </TableRow>
                    );
