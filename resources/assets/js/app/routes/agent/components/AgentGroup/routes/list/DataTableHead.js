...
const columnData = [
    ...
    {id: 'Group ', numeric: false,disablePadding: false, textAlign:'left', label: 'Group'},
    {id: 'Description ', numeric: true, disablePadding: false,  textAlign:'left' , label: ' Description '}, 
    {id: 'Force Time Clock ', numeric: true, disablePadding: false, textAlign:'left', label: 'Force Time Clock'},
