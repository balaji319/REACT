...
class CommanTable extends React.Component {
    ...
    componentWillReceiveProps(nextProps) {
        this.setState({
            data : nextProps.mydata.data.commonarray15min['timearray'],
            data2 : nextProps.mydata.data.commonarray15min,
        });
    }
            ...
            <div>
                ...
                <div className="table-responsive-material">
                            <Table>
                                ...
                                <TableBody>
                                    {
                                        this.props.mydata.data.seventhTable['call_ans_time_break_down'].length != null ?
                                        this.props.mydata.data.seventhTable['call_ans_time_break_down'].map((val,key) => 
                                    ...
                                    <TableRow>
                                        ...
                                        <TableCell></TableCell>
                                        <TableCell></TableCell>     
                                        <TableCell>{this.props.mydata.data.seventhTable['finaltotal']}</TableCell>
                                    </TableRow>                   
                                </TableBody>
