...
class CampaignMultidropdownList extends React.Component {
constructor(props) {
   super(props);
   this.state = {
       userGroups:[],
           ...
           <FormControl className="w-100 mb-2">
               ...
               <Select
                   ...
                   {Object.keys(this.props.options).map((name,i )=> (
                       <MenuItem
                           key={i}
                           value={this.props.options[name].campaign_id}
                           style={{
                               fontWeight: this.props.selectedValue.indexOf(this.props.options[name]) !== -1 ? '500' : '400',
                           }}>
                           {this.props.options[name].campaign_id+"-"+this.props.options[name].campaign_name}
                       </MenuItem>
                   ))}
...
export default CampaignMultidropdownList;