...
class MultipleDropdownCampaigns extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            userGroups:[],
                    ...
                    <Select
                        ...
                        { Object.keys(this.props.options).map((item, i) => (
                             <MenuItem
                                ...
                                {this.props.options[item].campaign_id + "-" + this.props.options[item].campaign_name}
                            </MenuItem>
                        ))}
...
export default MultipleDropdownCampaigns;