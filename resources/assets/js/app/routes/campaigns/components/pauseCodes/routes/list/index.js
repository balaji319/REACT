...
const columnData = [
  ...
  { id: "Name", label: "Name" },
  { id: "Pause Codes", label: "Pause Codes" },
...
class List extends React.Component {
  ...
  onSearchChange = name => e => {
    ...
    this.props.getCampaignPauseCodes(0, rowsPerPage, this.state.search_value);
  };
  // Pagination section
  getCampaignStatusList(page = 0, page_size = 10) {
    ...
    this.props.getCampaignPauseCodes(current_page, page_size);
  }
  ...
  render() {
    ...
    return (
      <div>
        <ContainerHeader match={this.props.match} title="Codes" />
        <Paper>
          <Toolbar className="table-header">
            <div className="title">
              <h3>
                <i className="zmdi zmdi-view-web mr-2" /> Pause Codes Listing
              </h3>
            </div>
            ...
            >
              <DialogTitle>{"Clone a Pause Code "}</DialogTitle>
              <DialogContent>
                <Clone
                            ...
                            <Tooltip title="Modify Campaign Status ">
                              <IconButton>
                                ...
                                >
                                  <i
                                    className={
                                      n.modify ? "fa fa-pencil" : "fa fa-plus"
                                    }
                                  />
                                </a>
                              </IconButton>
