...
export const single_items_data = [
  {
    status: "",
    attempt_delay: "",
    attempt_maximum: "",
...
//127.0.0.1:8000/api/campaign-mix-options-lists?campaign_id=040588&&list=false
export const headerData = [
  { id: "Recycle_id", label: "Recycle Id" },
  { id: "status", label: "status" },
  { id: "Attempt_delay", textAlign: " text-center", label: "Attempt Dealy" },
  { id: "Attempt_maximum", label: "Attempt Maximum" },
  { id: "Active", label: "Active" },
  { id: "Modify", label: "Modify", align: "center" },
