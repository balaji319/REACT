...
import { getCallTransferPresetsList } from "../../../../actions/";
...
class List extends React.Component {
  ...
  onSearchChange = name => e => {
    ...
    this.props.getCallTransferPresetsList(
      0,
      rowsPerPage,
  ...
  getCampaignRecycleList(page = 0, page_size = 10) {
    ...
    this.props.getCallTransferPresetsList(current_page, page_size);
  }
    ...
    return (
      <div>
        <ContainerHeader
          ...
          title="Call Transfer Presets Listing:"
        />
        ...
        <Paper>
          <Toolbar className="table-header">
            ...
            >
              <DialogTitle>{"Clone a Call Transfer Presets "}</DialogTitle>
              <DialogContent>
                <Clone
          ...
          <div className="flex-auto">
            <div className="table-responsive-material table-custom-style ">
              <Table
                ...
                <TableBody>
                  {ajaxdata &&
                    this.props.Campaign.sectionin ==
                      "Campaign call tranfer Success" &&
                    ajaxdata.map((n, i) => {
                      return (
                        <TableRow key={i}>
                          <TableCell style={{width: '10%'}}>{n.campaign_id}</TableCell>
                          <TableCell style={{width: '10%'}} >{n.campaign_name}</TableCell>
                          <TableCell>{n.preset_name}</TableCell>
                          <TableCell className="text-center" style={{width: '10%'}}>
                            <Tooltip title="Modify Campaign Pause code ">
                              <IconButton>
                                <a
                                  className="teal-text"
                                  onClick={() =>
