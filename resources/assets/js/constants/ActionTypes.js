...
export const CHANGE_NAVIGATION_STATUS = 'Show Side Bar ';
export const CHANGE_HIDE_NAVIGATION_STATUS = 'Hide Side Bar ';
...
//// Auth Api 
export const USER_AUTH_API = '/api/auth/login';
export const USER_RESET_API = '/api/auth/reset';
export const USER_LOGOUT_API = '/api/auth/logout';
...
export const GLOBAL_FAILURE_MEASSAGE = 'Something went wrong !!!!';



/*  Globel  */
 
export const REQUEST_ALL_CAMPAIN_GLOBEL = 'Globel Campaign Request';
export const FETCH_ALL_CAMPAIN_GLOBEL_SUCSESS  = ' Globel Campaign Request Records Fetched  Sucsessfully';
export const FETCH_ALL_CAMPAIN_GLOBEL_FAIL  = ' Globel Campaign  Records Request Failed';




/*  Globel API  */
export const API_FETCH_ALL_CAMPAIN = 'api/global-api';
export const API_FETCH_ALL_AGENTSLIST = 'api/globel-getagentlist';



export const API_SWICH_DB_GLOBEL = '/api/update_db';
