...
class LeadFilterCloneRequset extends FormRequest
{
    /**
    ...
    public function messages() {
        return [
            ...
            'new_id.alpha_num' =>'Only letters, or numbers are allowed for Lead Filter ID.',
            'new_id.unique' => 'Lead Filter ID already exists.',
